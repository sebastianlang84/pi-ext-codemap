...
> Historical archive: this note preserves the original idea exploration and is no longer authoritative. Use [`../../README.md`](../../README.md), [`../product/PRD.md`](../product/PRD.md), and [`../product/roadmap.md`](../product/roadmap.md) for the current product contract and future-work list.
