...
1. [ ] Nächsten Expanded-Natural-Holdout-Fix-Slice auswählen.
   - Aktuelle sichtbare Misses: keine im Natural-Holdout-`codemap_search_context`; nächster Slice sollte den Holdout erweitern oder die zwei Baseline-Restgrenzen gezielt prüfen.
