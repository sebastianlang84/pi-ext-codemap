...
1. [ ] DB-/Migration-Schema-Tests ergänzen.
...
2. [ ] Fehlgeschlagene Natural-Language-Benchmark-Cases als konkrete Regressionen bearbeiten.
...
3. [ ] Thin CLI Adapter über `src/core/` ergänzen.
...
4. [ ] Refresh-Automation als expliziten Command oder Hook entscheiden.
...
5. [ ] Später: Autoresearch als Parameter-Tuning-Schleife prüfen.
