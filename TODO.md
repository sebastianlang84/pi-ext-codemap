...
1. [ ] Nächsten Expanded-Natural-Holdout-Fix-Slice auswählen.
   - Aktuelle sichtbare Misses: pi-ext-memory Handoff-Code↔ADR, pi-ext-subagents Reviewer-Scout-Docs↔Benchmark.
